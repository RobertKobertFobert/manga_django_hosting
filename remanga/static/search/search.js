    ...
    search_endless_scroll.gridPlaceholder.insertAdjacentHTML("beforebegin", `              
      <div class="gridItem">
        <a
          ...
          style="height: 100%;">
          <div class="Vertical_wrapper__eThs_" style="height: 100%;">
            <div
              class="Image_container__NpLCh Image_hover__XbAZP rounded-md  Image_imagePlaceholder__oa9r1"
              style="height: 100%;">
              <img
                src="/media/titles/${title["img_url"]}" style="width: 100%;height: 100%;" onerror="reload_page()">
            </div>
